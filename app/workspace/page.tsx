...
export default function Workspace() {
  ...
  async function upload(file: File) {
    ...
    if (response.ok) { const result = await response.json(); setAsset(result.asset); setStatus("READY"); } else setStatus("UPLOAD FAILED");
  }
