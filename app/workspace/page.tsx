...
export default function Workspace() {
  ...
  return <main className="shell">
    ...
    <section className="grid">
      ...
      <article className="panel forma-panel"><div className="panel-head"><span>05 / MATERIALIZE</span><b>FORMA OUTPUT</b><span className="count">{formaStatus}</span></div><div className="output-art">{formaResult ? <><span>✓</span><small>GENERATION COMPLETE<br />{selected.name}</small></> : <><span>◈</span><small>3D PREVIEW<br />AWAITING GENERATION</small></>}</div><button className="outline" onClick={sendToForma} disabled={!intent || formaStatus === "GENERATING..."}>SEND TO FORMA  →</button></article>
    </section>
